#!/usr/bin/env python3
"""Write TV Units & Media service page for Inbuilt Atelier."""
import os
  ...
  <div class="nav-center"><ul class="nav-links">
    ...
    <li class="nav-item-dropdown"><a href="/service/" class="active">Services &#9662;</a>
      <ul class="dropdown-menu">
        ...
        <li><a href="/service/growth-strategy-analytics/" class="active">TV Units &amp; Media</a></li>
      </ul>
    </li>
...
<head>
    ...
    <title>Custom TV Units &amp; Media Joinery Sydney | Inbuilt Atelier</title>
    <meta name="description" content="Bespoke TV units, entertainment walls, and media joinery for Sydney homes. Hidden cable management, speaker integration, and premium finishes. Double Bay studio.">
    <link rel="canonical" href="https://inbuiltatelier.com.au/service/growth-strategy-analytics/">
    <meta property="og:title" content="Custom TV Units &amp; Media Joinery Sydney | Inbuilt Atelier">
...
<section style="position:relative;min-height:52vh;background:var(--color-primary);display:flex;align-items:center;padding:8rem 0 5rem;overflow:hidden;">
  <div style="position:absolute;inset:0;background:radial-gradient(ellipse at 65% 35%,rgba(155,128,96,.12) 0%,transparent 65%);pointer-events:none;"></div>
  <div class="container" style="position:relative;z-index:2;">
    <nav aria-label="breadcrumb" style="margin-bottom:2rem;"><ol class="breadcrumb">
      ...
      <li style="color:var(--color-copper);">TV Units &amp; Media</li>
    </ol></nav>
    <div style="max-width:720px;">
      <div style="display:inline-flex;align-items:center;gap:.75rem;font-family:'Jost',sans-serif;font-size:.7rem;font-weight:500;letter-spacing:.22em;text-transform:uppercase;color:var(--color-copper);margin-bottom:1.5rem;"><span style="display:block;width:28px;height:1px;background:var(--color-copper);"></span>Living Room Joinery</div>
      <h1 style="font-family:'Cormorant Garamond',Georgia,serif;font-weight:300;font-size:clamp(3rem,6vw,5rem);line-height:1.05;color:var(--color-text-inverse);margin-bottom:1.5rem;letter-spacing:.02em;">TV Units &amp;<br><em style="font-style:italic;color:var(--color-copper);">Media Joinery</em></h1>
      <p style="font-family:'Jost',sans-serif;font-size:1.05rem;font-weight:300;line-height:1.85;color:rgba(245,242,237,.65);max-width:600px;">The wall behind your television should not be an afterthought. We design and build custom media joinery that makes your living room feel complete, intentional, and distinctly yours.</p>
    </div>
  </div>
</section>
...
<section style="padding:7rem 0;background:var(--color-bg-body);">
  <div class="container">
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:5rem;align-items:center;">
      <div>
        <div style="display:inline-flex;align-items:center;gap:.75rem;font-family:'Jost',sans-serif;font-size:.7rem;font-weight:500;letter-spacing:.22em;text-transform:uppercase;color:var(--color-accent);margin-bottom:1.25rem;"><span style="display:block;width:28px;height:1px;background:var(--color-accent);"></span>Hidden Technology</div>
        <h2 style="font-family:'Cormorant Garamond',Georgia,serif;font-weight:300;font-size:clamp(2rem,3.5vw,2.75rem);line-height:1.1;color:var(--color-primary);margin-bottom:1.5rem;">Beautiful on the Outside, Brilliantly Functional Within</h2>
        <p style="font-family:'Jost',sans-serif;font-size:.97rem;font-weight:300;line-height:1.85;color:var(--color-text-secondary);margin-bottom:1.25rem;">We specialise in media joinery that conceals all the technology while presenting a clean, architectural face to your living space. No cables visible. No loose components. Just a wall of considered joinery.</p>
        <p style="font-family:'Jost',sans-serif;font-size:.97rem;font-weight:300;line-height:1.85;color:var(--color-text-secondary);margin-bottom:2rem;">From full-height entertainment walls with integrated fireplace surrounds to sleek floating TV credenzas with push-to-open doors, we handle every configuration.</p>
      ...
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:1px;background:var(--border-light);">
        <div class="feature-card"><div style="width:36px;height:1px;background:var(--color-accent);margin-bottom:1.25rem;"></div><h3 style="font-family:'Cormorant Garamond',Georgia,serif;font-weight:400;font-size:1.2rem;color:var(--color-primary);margin-bottom:.6rem;">Full-Height Media Walls</h3><p style="font-family:'Jost',sans-serif;font-size:.85rem;font-weight:300;color:var(--color-text-secondary);line-height:1.75;">Floor-to-ceiling joinery with TV mounting, flanking display shelves, concealed AV equipment, and fireplace integration.</p></div>
        <div class="feature-card"><div style="width:36px;height:1px;background:var(--color-accent);margin-bottom:1.25rem;"></div><h3 style="font-family:'Cormorant Garamond',Georgia,serif;font-weight:400;font-size:1.2rem;color:var(--color-primary);margin-bottom:.6rem;">Floating TV Credenzas</h3><p style="font-family:'Jost',sans-serif;font-size:.85rem;font-weight:300;color:var(--color-text-secondary);line-height:1.75;">Wall-hung low-line units with push-to-open doors, ventilated AV bays, and cable slots &mdash; in any finish or length.</p></div>
        <div class="feature-card"><div style="width:36px;height:1px;background:var(--color-accent);margin-bottom:1.25rem;"></div><h3 style="font-family:'Cormorant Garamond',Georgia,serif;font-weight:400;font-size:1.2rem;color:var(--color-primary);margin-bottom:.6rem;">Cable Management</h3><p style="font-family:'Jost',sans-serif;font-size:.85rem;font-weight:300;color:var(--color-text-secondary);line-height:1.75;">Every cable route is planned in the design phase &mdash; power points in-wall, HDMI conduits, and tidy equipment bays.</p></div>
        <div class="feature-card"><div style="width:36px;height:1px;background:var(--color-accent);margin-bottom:1.25rem;"></div><h3 style="font-family:'Cormorant Garamond',Georgia,serif;font-weight:400;font-size:1.2rem;color:var(--color-primary);margin-bottom:.6rem;">Integrated Fireplaces</h3><p style="font-family:'Jost',sans-serif;font-size:.85rem;font-weight:300;color:var(--color-text-secondary);line-height:1.75;">Electric or bioethanol fireplace surrounds built into the media wall as the centrepiece of the living room.</p></div>
      </div>
    </div>
  </div>
</section>
...
<section style="padding:6rem 0;background:var(--color-primary);text-align:center;">
  <div class="container" style="max-width:680px;margin:0 auto;">
    <h2 style="font-family:'Cormorant Garamond',Georgia,serif;font-weight:300;font-size:clamp(2.25rem,4vw,3.25rem);line-height:1.1;color:var(--color-text-inverse);margin-bottom:1.5rem;">Design Your Media Wall</h2>
    <p style="font-family:'Jost',sans-serif;font-size:.97rem;font-weight:300;line-height:1.85;color:rgba(245,242,237,.55);margin-bottom:2.5rem;">Share your TV wall dimensions and current setup. We will show you how to transform it into the focal point of your home.</p>
...
target = os.path.join(base, 'public', 'service', 'growth-strategy-analytics', 'index.html')
