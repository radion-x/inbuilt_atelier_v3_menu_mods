#!/usr/bin/env python3
"""Write Joinery & Cabinetry service page for Inbuilt Atelier."""
  ...
  <div class="nav-center"><ul class="nav-links">
    ...
    <li class="nav-item-dropdown"><a href="/service/" class="active">Services &#9662;</a>
      <ul class="dropdown-menu">
        ...
        <li><a href="/service/seo-local-seo/" class="active">Joinery &amp; Cabinetry</a></li>
...
<div id="aiChatWidget" class="ai-chat-widget">
  ...
  <div id="chatWindow" class="chat-window hidden">
    ...
    <form id="chatForm" class="chat-form">
      <input type="text" id="chatInput" placeholder="Ask about our joinery..." autocomplete="off" required>
...
<head>
    ...
    <title>Joinery &amp; Cabinetry Sydney | Custom Fitted Cabinetry | Inbuilt Atelier</title>
    <meta name="description" content="Bespoke joinery and fitted cabinetry for Sydney homes. Bookcases, entertainment units, hallway storage, laundry cabinetry, and more. Custom designed at our Double Bay studio.">
    <meta name="keywords" content="custom joinery sydney, bespoke cabinetry sydney, fitted cabinetry double bay, custom built cabinetry eastern suburbs">
    <link rel="canonical" href="https://inbuiltatelier.com.au/service/seo-local-seo/">
    <meta property="og:title" content="Joinery &amp; Cabinetry Sydney | Inbuilt Atelier">
    <meta property="og:description" content="Bespoke joinery and fitted cabinetry for Sydney homes.">
...
<section style="position:relative;min-height:55vh;background:var(--color-primary);display:flex;align-items:center;padding:8rem 0 5rem;overflow:hidden;">
  <div style="position:absolute;inset:0;background:radial-gradient(ellipse at 70% 60%,rgba(155,128,96,.1) 0%,transparent 65%);pointer-events:none;"></div>
  <div class="container" style="position:relative;z-index:2;">
    <nav aria-label="breadcrumb" style="margin-bottom:2rem;">
      <ol class="breadcrumb">
        ...
        <li style="color:rgba(245,242,237,.45);">&middot;</li>
        <li style="color:var(--color-copper);">Joinery &amp; Cabinetry</li>
      </ol>
    </nav>
    <div style="max-width:720px;">
      <div style="display:inline-flex;align-items:center;gap:.75rem;font-family:'Jost',sans-serif;font-size:.7rem;font-weight:500;letter-spacing:.22em;text-transform:uppercase;color:var(--color-copper);margin-bottom:1.5rem;">
        <span style="display:block;width:28px;height:1px;background:var(--color-copper);"></span>Whole-Home Solutions
      </div>
      <h1 style="font-family:'Cormorant Garamond',Georgia,serif;font-weight:300;font-size:clamp(3rem,6vw,5rem);line-height:1.05;color:var(--color-text-inverse);margin-bottom:1.5rem;letter-spacing:.02em;">
        Joinery &amp;<br><em style="font-style:italic;color:var(--color-copper);">Cabinetry</em>
      </h1>
      <p style="font-family:'Jost',sans-serif;font-size:1.05rem;font-weight:300;line-height:1.85;color:rgba(245,242,237,.65);max-width:600px;">
        Every room in a home has storage needs. We design and build fitted cabinetry that solves them beautifully &mdash; from entryway joinery to full-height library walls and everything in between.
      </p>
    </div>
  </div>
</section>
  ...
  <div class="container">
    <div style="text-align:center;max-width:600px;margin:0 auto 4.5rem;">
      <div style="display:inline-flex;align-items:center;gap:.75rem;font-family:'Jost',sans-serif;font-size:.7rem;font-weight:500;letter-spacing:.22em;text-transform:uppercase;color:var(--color-accent);margin-bottom:1rem;">
        <span style="display:block;width:28px;height:1px;background:var(--color-accent);"></span>What We Build<span style="display:block;width:28px;height:1px;background:var(--color-accent);"></span>
      </div>
      <h2 style="font-family:'Cormorant Garamond',Georgia,serif;font-weight:300;font-size:clamp(2rem,3.5vw,2.75rem);line-height:1.1;color:var(--color-primary);">Cabinetry for Every Room</h2>
      <p style="font-family:'Jost',sans-serif;font-size:.95rem;font-weight:300;line-height:1.85;color:var(--color-text-secondary);margin-top:1rem;">Whether it is a single storage challenge or a whole-home joinery programme, we approach every project with the same attention and craft.</p>
    </div>
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(300px,1fr));gap:1px;background:var(--border-light);">
      <div class="feature-card">
        ...
        <h3 style="font-family:'Cormorant Garamond',Georgia,serif;font-weight:400;font-size:1.35rem;color:var(--color-primary);margin-bottom:.75rem;">Library &amp; Bookcase Walls</h3>
        <p style="font-family:'Jost',sans-serif;font-size:.9rem;font-weight:300;line-height:1.8;color:var(--color-text-secondary);">Floor-to-ceiling shelving with ladder rails, integrated display niches, and concealed cabinet doors — the centrepiece of any living or study space.</p>
      </div>
      <div class="feature-card">
        <div style="width:36px;height:1px;background:var(--color-accent);margin-bottom:1.5rem;"></div>
        <h3 style="font-family:'Cormorant Garamond',Georgia,serif;font-weight:400;font-size:1.35rem;color:var(--color-primary);margin-bottom:.75rem;">Hallway &amp; Entry Storage</h3>
        <p style="font-family:'Jost',sans-serif;font-size:.9rem;font-weight:300;line-height:1.8;color:var(--color-text-secondary);">Full-height entry cabinetry with shoe storage, coat hooks, key drawers, and display ledges — hard-working but refined.</p>
      </div>
      <div class="feature-card">
        <div style="width:36px;height:1px;background:var(--color-accent);margin-bottom:1.5rem;"></div>
        <h3 style="font-family:'Cormorant Garamond',Georgia,serif;font-weight:400;font-size:1.35rem;color:var(--color-primary);margin-bottom:.75rem;">Laundry Cabinetry</h3>
        <p style="font-family:'Jost',sans-serif;font-size:.9rem;font-weight:300;line-height:1.8;color:var(--color-text-secondary);">Custom cabinetry to make every laundry work efficiently — appliance housing, bench tops, hanging rails, and linen storage.</p>
      </div>
      <div class="feature-card">
        <div style="width:36px;height:1px;background:var(--color-accent);margin-bottom:1.5rem;"></div>
        <h3 style="font-family:'Cormorant Garamond',Georgia,serif;font-weight:400;font-size:1.35rem;color:var(--color-primary);margin-bottom:.75rem;">Pantry &amp; Butler&rsquo;s Pantry</h3>
        <p style="font-family:'Jost',sans-serif;font-size:.9rem;font-weight:300;line-height:1.8;color:var(--color-text-secondary);">Pull-out drawers, spice racks, appliance garages, and open shelving configured for how your household actually operates.</p>
      </div>
      <div class="feature-card">
        <div style="width:36px;height:1px;background:var(--color-accent);margin-bottom:1.5rem;"></div>
        <h3 style="font-family:'Cormorant Garamond',Georgia,serif;font-weight:400;font-size:1.35rem;color:var(--color-primary);margin-bottom:.75rem;">Under-Stair Cabinetry</h3>
        <p style="font-family:'Jost',sans-serif;font-size:.9rem;font-weight:300;line-height:1.8;color:var(--color-text-secondary);">We make use of every awkward volume — angled drawers, wine storage, pull-out units, and concealed doors that look intentional.</p>
      </div>
      <div class="feature-card">
        <div style="width:36px;height:1px;background:var(--color-accent);margin-bottom:1.5rem;"></div>
        <h3 style="font-family:'Cormorant Garamond',Georgia,serif;font-weight:400;font-size:1.35rem;color:var(--color-primary);margin-bottom:.75rem;">Bespoke Display &amp; Niche Work</h3>
        <p style="font-family:'Jost',sans-serif;font-size:.9rem;font-weight:300;line-height:1.8;color:var(--color-text-secondary);">Floating shelves, art niches, fireplace surrounds, and custom joinery details that give a room its defining character.</p>
      </div>
    </div>
  </div>
</section>
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:5rem;align-items:center;">
      <div>
        <div style="display:inline-flex;align-items:center;gap:.75rem;font-family:'Jost',sans-serif;font-size:.7rem;font-weight:500;letter-spacing:.22em;text-transform:uppercase;color:var(--color-accent);margin-bottom:1.25rem;">
          <span style="display:block;width:28px;height:1px;background:var(--color-accent);"></span>Our Approach
        </div>
        <h2 style="font-family:'Cormorant Garamond',Georgia,serif;font-weight:300;font-size:clamp(2rem,3.5vw,2.75rem);line-height:1.1;color:var(--color-primary);margin-bottom:1.5rem;">
          Joinery That Integrates, Not Just Decorates
        </h2>
        <p style="font-family:'Jost',sans-serif;font-size:.97rem;font-weight:300;line-height:1.85;color:var(--color-text-secondary);margin-bottom:1.25rem;">
          The best joinery disappears into the architecture. We design with your existing cornices, skirtings, ceiling heights, and floor finishes in mind &mdash; so fitted cabinetry looks as if it was always there.
        </p>
        <p style="font-family:'Jost',sans-serif;font-size:.97rem;font-weight:300;line-height:1.85;color:var(--color-text-secondary);margin-bottom:2rem;">
          We handle the complete process from design through to installation, and we never subcontract fitment. The craftspeople who build your cabinetry are the same people who install it.
        </p>
        <a href="/contact/" class="btn btn-primary">Book a Consultation</a>
      </div>
      <div style="display:flex;flex-direction:column;gap:1.5rem;">
        <div style="display:flex;gap:1.25rem;align-items:flex-start;padding:1.75rem;border:1px solid var(--border-light);">
          <span style="font-family:'Cormorant Garamond',Georgia,serif;font-size:1.75rem;font-weight:300;color:var(--color-accent);min-width:32px;line-height:1;">I</span>
          <div>
            <h3 style="font-family:'Jost',sans-serif;font-size:.88rem;font-weight:500;color:var(--color-primary);margin-bottom:.4rem;">Designed to the Room</h3>
            <p style="font-family:'Jost',sans-serif;font-size:.88rem;font-weight:300;color:var(--color-text-secondary);line-height:1.7;">We account for every architectural quirk &mdash; no off-the-shelf modules adapted to fit.</p>
          </div>
        </div>
        <div style="display:flex;gap:1.25rem;align-items:flex-start;padding:1.75rem;border:1px solid var(--border-light);">
          <span style="font-family:'Cormorant Garamond',Georgia,serif;font-size:1.75rem;font-weight:300;color:var(--color-accent);min-width:32px;line-height:1;">II</span>
          <div>
            <h3 style="font-family:'Jost',sans-serif;font-size:.88rem;font-weight:500;color:var(--color-primary);margin-bottom:.4rem;">In-House Workshop</h3>
            <p style="font-family:'Jost',sans-serif;font-size:.88rem;font-weight:300;color:var(--color-text-secondary);line-height:1.7;">Everything is manufactured in-house to our own tolerances &mdash; not outsourced to a factory.</p>
          </div>
        </div>
        <div style="display:flex;gap:1.25rem;align-items:flex-start;padding:1.75rem;border:1px solid var(--border-light);">
          <span style="font-family:'Cormorant Garamond',Georgia,serif;font-size:1.75rem;font-weight:300;color:var(--color-accent);min-width:32px;line-height:1;">III</span>
          <div>
            <h3 style="font-family:'Jost',sans-serif;font-size:.88rem;font-weight:500;color:var(--color-primary);margin-bottom:.4rem;">Fixed-Price Proposals</h3>
            <p style="font-family:'Jost',sans-serif;font-size:.88rem;font-weight:300;color:var(--color-text-secondary);line-height:1.7;">You receive a detailed fixed-price quote before any work begins. No surprises at installation.</p>
          </div>
        </div>
      </div>
    </div>
...
<section style="padding:6rem 0;background:var(--color-primary);text-align:center;">
  <div class="container" style="max-width:680px;margin:0 auto;">
    ...
    <p style="font-family:'Jost',sans-serif;font-size:.97rem;font-weight:300;line-height:1.85;color:rgba(245,242,237,.55);margin-bottom:2.5rem;">
      Book a free consultation and bring your floor plan or photos. We will show you the possibilities.
    </p>
...
target = os.path.join(base, 'public', 'service', 'seo-local-seo', 'index.html')
