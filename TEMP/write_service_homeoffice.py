#!/usr/bin/env python3
"""Write Home Office service page for Inbuilt Atelier."""
import os
...
COMMON_CSS = """\
    ...
    <style>
        ...
        .feature-card{padding:2rem;border:1px solid var(--border-light);background:#fff;transition:border-color .3s}
  ...
  <div class="nav-center"><ul class="nav-links">
    ...
    <li class="nav-item-dropdown"><a href="/service/" class="active">Services &#9662;</a>
      <ul class="dropdown-menu">
        ...
        <li><a href="/service/crm-sales-funnel/" class="active">Home Office</a></li>
...
<head>
    ...
    <title>Custom Home Office Joinery Sydney | Built-In Desk &amp; Storage | Inbuilt Atelier</title>
    <meta name="description" content="Bespoke home office joinery for Sydney homes — built-in desks, bookshelves, filing cabinets, and full study walls designed at our Double Bay studio.">
    <link rel="canonical" href="https://inbuiltatelier.com.au/service/crm-sales-funnel/">
    <meta property="og:title" content="Custom Home Office Joinery Sydney | Inbuilt Atelier">
...
<section style="position:relative;min-height:52vh;background:var(--color-primary);display:flex;align-items:center;padding:8rem 0 5rem;overflow:hidden;">
  <div style="position:absolute;inset:0;background:radial-gradient(ellipse at 40% 50%,rgba(155,128,96,.12) 0%,transparent 65%);pointer-events:none;"></div>
  <div class="container" style="position:relative;z-index:2;">
    <nav aria-label="breadcrumb" style="margin-bottom:2rem;"><ol class="breadcrumb">
      ...
      <li style="color:var(--color-copper);">Home Office</li>
    </ol></nav>
    <div style="max-width:720px;">
      <div style="display:inline-flex;align-items:center;gap:.75rem;font-family:'Jost',sans-serif;font-size:.7rem;font-weight:500;letter-spacing:.22em;text-transform:uppercase;color:var(--color-copper);margin-bottom:1.5rem;"><span style="display:block;width:28px;height:1px;background:var(--color-copper);"></span>Study &amp; Workspace Joinery</div>
      <h1 style="font-family:'Cormorant Garamond',Georgia,serif;font-weight:300;font-size:clamp(3rem,6vw,5rem);line-height:1.05;color:var(--color-text-inverse);margin-bottom:1.5rem;letter-spacing:.02em;">Home Office<br><em style="font-style:italic;color:var(--color-copper);">Joinery</em></h1>
      <p style="font-family:'Jost',sans-serif;font-size:1.05rem;font-weight:300;line-height:1.85;color:rgba(245,242,237,.65);max-width:600px;">A home office should feel like a professional workspace, not a spare room with a flat-pack desk. We build study and office joinery that is crafted to last and designed to inspire.</p>
    </div>
  </div>
</section>
...
<section style="padding:7rem 0;background:var(--color-bg-body);">
  <div class="container">
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:5rem;align-items:start;">
      <div>
        <div style="display:inline-flex;align-items:center;gap:.75rem;font-family:'Jost',sans-serif;font-size:.7rem;font-weight:500;letter-spacing:.22em;text-transform:uppercase;color:var(--color-accent);margin-bottom:1.25rem;"><span style="display:block;width:28px;height:1px;background:var(--color-accent);"></span>What We Create</div>
        <h2 style="font-family:'Cormorant Garamond',Georgia,serif;font-weight:300;font-size:clamp(2rem,3.5vw,2.75rem);line-height:1.1;color:var(--color-primary);margin-bottom:1.5rem;">A Workspace Designed Around How You Work</h2>
        <p style="font-family:'Jost',sans-serif;font-size:.97rem;font-weight:300;line-height:1.85;color:var(--color-text-secondary);margin-bottom:1.25rem;">Whether you need a dedicated study room, a built-in desk nook, or a full executive home office, we design every element around your workflow, your technology, and your aesthetic.</p>
        <p style="font-family:'Jost',sans-serif;font-size:.97rem;font-weight:300;line-height:1.85;color:var(--color-text-secondary);margin-bottom:2rem;">Cable management, monitor mounting, printer storage, deep drawers for files, and shelving configured exactly as your reference library demands &mdash; all within a design that complements the rest of your home.</p>
        <a href="/contact/" class="btn btn-primary">Book a Consultation</a>
      </div>
      <div style="display:flex;flex-direction:column;gap:1px;background:var(--border-light);">
        <div class="feature-card"><div style="width:36px;height:1px;background:var(--color-accent);margin-bottom:1.25rem;"></div><h3 style="font-family:'Cormorant Garamond',Georgia,serif;font-weight:400;font-size:1.25rem;color:var(--color-primary);margin-bottom:.6rem;">Built-In Desks</h3><p style="font-family:'Jost',sans-serif;font-size:.88rem;font-weight:300;color:var(--color-text-secondary);line-height:1.75;">Full-width fitted desks with integrated cable trays, monitor risers, keyboard drawers, and matching joinery walls.</p></div>
        <div class="feature-card"><div style="width:36px;height:1px;background:var(--color-accent);margin-bottom:1.25rem;"></div><h3 style="font-family:'Cormorant Garamond',Georgia,serif;font-weight:400;font-size:1.25rem;color:var(--color-primary);margin-bottom:.6rem;">Study Walls</h3><p style="font-family:'Jost',sans-serif;font-size:.88rem;font-weight:300;color:var(--color-text-secondary);line-height:1.75;">Floor-to-ceiling library and bookcase walls with enclosed filing cabinets, display niches, and concealed printer housing.</p></div>
        <div class="feature-card"><div style="width:36px;height:1px;background:var(--color-accent);margin-bottom:1.25rem;"></div><h3 style="font-family:'Cormorant Garamond',Georgia,serif;font-weight:400;font-size:1.25rem;color:var(--color-primary);margin-bottom:.6rem;">Dual Workstations</h3><p style="font-family:'Jost',sans-serif;font-size:.88rem;font-weight:300;color:var(--color-text-secondary);line-height:1.75;">Twin desk configurations for households where two people work from home &mdash; individual storage, shared central shelving.</p></div>
        <div class="feature-card"><div style="width:36px;height:1px;background:var(--color-accent);margin-bottom:1.25rem;"></div><h3 style="font-family:'Cormorant Garamond',Georgia,serif;font-weight:400;font-size:1.25rem;color:var(--color-primary);margin-bottom:.6rem;">Murphy Bed &amp; Office Combos</h3><p style="font-family:'Jost',sans-serif;font-size:.88rem;font-weight:300;color:var(--color-text-secondary);line-height:1.75;">Clever dual-function guest room and home office solutions where space is premium but compromise is not an option.</p></div>
      </div>
    </div>
  </div>
</section>
...
<section style="padding:6rem 0;background:var(--color-primary);text-align:center;">
  <div class="container" style="max-width:680px;margin:0 auto;">
    <h2 style="font-family:'Cormorant Garamond',Georgia,serif;font-weight:300;font-size:clamp(2.25rem,4vw,3.25rem);line-height:1.1;color:var(--color-text-inverse);margin-bottom:1.5rem;">Design Your Home Office</h2>
    <p style="font-family:'Jost',sans-serif;font-size:.97rem;font-weight:300;line-height:1.85;color:rgba(245,242,237,.55);margin-bottom:2.5rem;">Tell us about your space and how you work. We will design a study solution that makes your home feel complete.</p>
...
target = os.path.join(base, 'public', 'service', 'crm-sales-funnel', 'index.html')
